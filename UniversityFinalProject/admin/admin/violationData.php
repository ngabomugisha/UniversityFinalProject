...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
    <div class="table-responsive">  <table class="table table-striped table-bordered" id="employee_data" width="1400" cellspacing="0" style="width:800">
        ...
        $sql = "SELECT * FROM violation WHERE speed >= 5 AND speed IN( SELECT DISTINCT(speed) FROM violation GROUP BY speed ) GROUP BY speed;";
        $result = mysqli_query($con, $sql);
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
											echo'<tr>
													...
													<td>'.$row['c_plate'].'</td>
													<td>'.$row['r_id'].'</td>
                          <td>'.$row['speed'].'Cm/s</td>';
                          ?>
													<td>
                          <?php echo $row['v_status'].'</td>
