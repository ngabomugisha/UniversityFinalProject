  ...
  <div class="card-body">
    ...
    <div class="table-responsive">
      ...
      <table class="table table-striped table-bordered" id="employee_data" width="1400" cellspacing="0" style="width:800">
        ...
        $sql = "SELECT * FROM cars ORDER BY c_id DESC";
        $result = mysqli_query($con, $sql);
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
                        ...
                        <form action="" method="post">
                            ...
                            <a  href="edit_data.php?uID=<?php echo $row['c_id']; ?>"" name="edit_btn" class="btn btn-success"> EDIT</a>
                        </form>
                    </td>
                    <td>
                        <form action="" method="post">
                          <input type="hidden" name="delete_id" value="">
                          <a type="submit" name="delete_btn" class="btn btn-danger btn-icon-split" href="delete_data.php?delID=<?php echo $row['c_id'];?>"> DELETE</a>
                        </form>
                    </td>
                  </tr>
                        <?php
